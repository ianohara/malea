...
class ActivationFunction {
    ...
    //     Eigen::Matrix<BVal, Eigen::Dynamic, Eigen::Dynamic> Jacobian(size_t node_idx, const IOVector& node_inputs) override {
    ...
    //                     // There are a bunch of articles on this, or you can just do it by hand, but I think
    //                     // I like this article best: https://eli.thegreenplace.net/2016/the-softmax-function-and-its-derivative/
    //                     partial_derivs(idx_j) = apply_i * (1 - apply_j);
    //                 } else {
    ...
    //         IOVector dot_prod_results = (partial_derivs.array() * incoming_fn_derivs.array() * all_applied.array() / all_applied(node_idx));
    //         std::cout
